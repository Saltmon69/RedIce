...
public class MeshRandomSlicer : MonoBehaviour
{
 ...
 public class PartMesh
    {
        ...
        public void MakeGameobject(MeshRandomSlicer original)
        {
            ...
            var meshDestroy = GameObject.AddComponent<MeshRandomSlicer>();
